...
def menu():
       ...
       title_Frame = LabelFrame(root, font = ('arial',50,'bold'), width = 1000, height = 100, bg = 'red', relief = 'raise', bd = 13)
       ...
       Frame_3.grid(row = 4, column = 0, pady = 7)
       ...
       Label_3 = Label(Frame_3, text = 'MARKSHEET', font = ('arial',25,'bold'), bg = 'navajo white')
       ...
       Button_3 = Button(Frame_3, text = 'VIEW', font = ('arial',16,'bold'), width = 8, command = __marksheet__)
